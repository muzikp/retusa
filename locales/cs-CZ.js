module.exports = {
	...
	"EXYx": "kovariance",
	"AkjW": "Stanování hodnotu kovariance dvou vstupních numerických proměnných. Přijímá argument, zdali se jedná o výběrový či absolutní soubor.",
	"Cdly": "Analýza rozptylu dvojného třídění",
	"3FYm": "Stanoví statistický protokol analýzy rozptylu dvojného třídění. Metoda se používá mj. v experimentálních designech, kde je potřeba kromě vlivu hlavního faktoru třeba sledovat ještě vliv druhého faktoru - příkladem, první faktor může být účiinost léčiva, druhým faktorem experimentální/kontroní skupina. ",
	"WGqY": "faktor A",
	"O6Av": "faktor B",
	...
	"boBv": "prozkoumat vektor",
	"stFi": "Stanoví statistický protokol vybraných metod a testů pro daný vektor. Výstup se liší s ohledem na typ vektorů.",
	"HcqQ": "5% kvantil",
	"SoFH": "25% kvantil",
	"5Xgm": "75% kvantil",
	"KtLi": "95% kvantil",
	"Z5OQ": "Q-Q diagram",
	"92wX": "Stanoví řadu souřadnic bodů Q-Q diagramu.Ve statistice je Q–Q graf (kvantil-kvantilový graf) pravděpodobnostní graf, grafická metoda pro porovnání dvou rozdělení pravděpodobnosti vynesením jejich kvantilů proti sobě.[1] Bod (x, y) na grafu odpovídá jednomu z kvantilů druhého rozdělení (souřadnice y) vynesenému proti stejnému kvantilu prvního rozdělení (souřadnice x). Toto definuje parametrickou křivku, kde parametrem je index kvantilového intervalu.",
	"5LXq": "pozorované hodnoty",
	"grSJ": "očekávané normální",
	"3PCw": "P-P diagram",
	"WB2m": "Stanoví řadu souřadnic bodů P-P diagramu. Ve statistice je P–P graf (pravděpodobnost–pravděpodobnost nebo procento–procentní graf nebo graf hodnoty P) pravděpodobnostní graf pro posouzení, jak blízko se dva soubory dat shodují, nebo pro posouzení toho, jak blízko soubor dat odpovídá konkrétnímu modelu. Funguje tak, že vynese dvě kumulativní distribuční funkce proti sobě; pokud jsou podobné, data se budou jevit jako téměř přímka. Toto chování je podobné jako u více používaného grafu Q–Q, se kterým je často zaměňováno.",
	"TK3i": "očekávaná kumulativní pravděpodobnost",
	"aa8D": "pozorovaná kumulativní pravděpodobnost",
	"Mydr": "rok",
	"v6qI": "měsíc",
	"o3Mh": "den",
	"FKmI": "hodina",
